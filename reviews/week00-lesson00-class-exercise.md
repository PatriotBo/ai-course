...
> 日期：2026-06-17
> 类型：课堂练习 / 能力迁移诊断
> 状态：已完成课堂练习；课后作业也已提交并批改
> 关联作业：`../assignments/week00-lesson00-homework.md`
> 关联批改：`week00-lesson00-homework-review.md`
...
1. Lesson 0 课堂练习已完成，用于记录课中能力迁移诊断。
2. Lesson 0 课后作业已提交并完成批改，详见：`../assignments/week00-lesson00-homework.md` 与 `week00-lesson00-homework-review.md`。
3. `PROGRESS.md` 已将 L00 标记为已完成，下一课进入 Week 0 Lesson 1。

> 说明：课堂练习记录和课后作业批改是两类文件，不能混用。课堂练习只记录课中诊断；课后作业页负责保存题目、用户提交摘要和批改结果。
